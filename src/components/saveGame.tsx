...
//           const upgradeMap = props.upgradeMap.current;
//           upgradeMap.get('clickUpgrade')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker01')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker02')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker03')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker04')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker05')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker06')?.loadUpgrade(0);
//           upgradeMap.get('autoClicker07')?.loadUpgrade(0);
//           upgradeMap.get('refClicker01')?.loadUpgrade(0);
//           upgradeMap.get('refClicker02')?.loadUpgrade(0);
//           upgradeMap.get('refClicker03')?.loadUpgrade(0);
//           upgradeMap.get('refClicker04')?.loadUpgrade(0);
//           upgradeMap.get('refClicker05')?.loadUpgrade(0);
//           upgradeMap.get('adsClicker01')?.loadUpgrade(0);
//           upgradeMap.get('adsClicker02')?.loadUpgrade(0);
//           upgradeMap.get('adsClicker03')?.loadUpgrade(0);
//           upgradeMap.get('adsClicker04')?.loadUpgrade(0);
//       }
