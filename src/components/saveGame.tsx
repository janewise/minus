...
//  upgradeEnergyMap: React.MutableRefObject<Map<string, UpgradeEnergy>>;
  ...
  function handleSave() {
    ...
    localStorage.setItem(
     ...
     localStorage.setItem("RC6Level", JSON.stringify(props.upgradeMap.current.get('refClicker06')!.level))
     localStorage.setItem("RC7Level", JSON.stringify(props.upgradeMap.current.get('refClicker07')!.level))
     localStorage.setItem("RC8Level", JSON.stringify(props.upgradeMap.current.get('refClicker08')!.level))
     localStorage.setItem("RC9Level", JSON.stringify(props.upgradeMap.current.get('refClicker09')!.level))
     localStorage.setItem("RC10Level", JSON.stringify(props.upgradeMap.current.get('refClicker10')!.level))
     localStorage.setItem("RC11Level", JSON.stringify(props.upgradeMap.current.get('refClicker11')!.level))
     localStorage.setItem("RC12Level", JSON.stringify(props.upgradeMap.current.get('refClicker12')!.level))
     localStorage.setItem("RC13Level", JSON.stringify(props.upgradeMap.current.get('refClicker13')!.level))
     localStorage.setItem("RC14Level", JSON.stringify(props.upgradeMap.current.get('refClicker14')!.level))
    ...
    localStorage.setItem("AD5Level", JSON.stringify(props.upgradeMap.current.get('adsClicker05')!.level))
    localStorage.setItem("AD6Level", JSON.stringify(props.upgradeMap.current.get('adsClicker06')!.level))
    localStorage.setItem("AD7Level", JSON.stringify(props.upgradeMap.current.get('adsClicker07')!.level))
    localStorage.setItem("AD8Level", JSON.stringify(props.upgradeMap.current.get('adsClicker08')!.level))
...
//D2
  ...
  function handleLoad() {
    ...
    loadUpgrade('refClicker06', parseInt(JSON.parse(localStorage.getItem("RC6Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker07', parseInt(JSON.parse(localStorage.getItem("RC7Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker08', parseInt(JSON.parse(localStorage.getItem("RC8Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker09', parseInt(JSON.parse(localStorage.getItem("RC9Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker10', parseInt(JSON.parse(localStorage.getItem("RC10Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker11', parseInt(JSON.parse(localStorage.getItem("RC11Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker12', parseInt(JSON.parse(localStorage.getItem("RC12Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker13', parseInt(JSON.parse(localStorage.getItem("RC13Level") || '0')), props.upgradeMap)
    loadUpgrade('refClicker14', parseInt(JSON.parse(localStorage.getItem("RC14Level") || '0')), props.upgradeMap)
   //ads
   ...
   loadUpgrade('adsClicker05', parseInt(JSON.parse(localStorage.getItem("AD5Level") || '0')), props.upgradeMap)
   loadUpgrade('adsClicker06', parseInt(JSON.parse(localStorage.getItem("AD6Level") || '0')), props.upgradeMap)
   loadUpgrade('adsClicker07', parseInt(JSON.parse(localStorage.getItem("AD7Level") || '0')), props.upgradeMap)
   loadUpgrade('adsClicker08', parseInt(JSON.parse(localStorage.getItem("AD8Level") || '0')), props.upgradeMap)
